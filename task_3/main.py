...
if __name__ == "__main__":
    ...
    print('')
    print(f"{'| Algorithms': <20} | {'Present pattern': <20} | {'Fake pattern': <20}")
    print(f":{'-'*19} | :{'-'*19} | :{'-'*19}")

    print(" Стаття 1")
    print(f":{'-'*19} | :{'-'*19} | :{'-'*19}")
    print(f"{'| KMP': <20} | {kmp_present_time_article_1:<20.7f} | {kmp_fake_time_article_1:<20.7f}")
    print(f"{'| BM': <20} | {bm_present_time_article_1:<20.7f} | {bm_fake_time_article_1:<20.7f}")
    print(f"{'| RK': <20} | {rk_present_time_article_1:<20.7f} | {rk_fake_time_article_1:<20.7f}")
    print(f":{'-'*19} | :{'-'*19} | :{'-'*19}")

    print(" Стаття 2")
    print(f":{'-'*19} | :{'-'*19} | :{'-'*19}")
    print(f"{'| KMP': <20} | {kmp_present_time_article_2:<20.7f} | {kmp_fake_time_article_2:<20.7f}")
    print(f"{'| BM': <20} | {bm_present_time_article_2:<20.7f} | {bm_fake_time_article_2:<20.7f}")
    print(f"{'| RK': <20} | {rk_present_time_article_2:<20.7f} | {rk_fake_time_article_2:<20.7f}")
